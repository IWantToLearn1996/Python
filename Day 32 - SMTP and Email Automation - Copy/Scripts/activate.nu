...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\nikos\Desktop\100 Days of Python Code\Day 32 - SMTP and Email Automation'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\nikos\Desktop\100 Days of Python Code\Day 32 - SMTP and Email Automation\Scripts\deactivate.nu'
