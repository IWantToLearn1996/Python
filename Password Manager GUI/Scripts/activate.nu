...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\nikos\Desktop\100 Days of Python Code\Day 29 - Password Manager GUI'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\nikos\Desktop\100 Days of Python Code\Day 29 - Password Manager GUI\Scripts\deactivate.nu'
