...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\nikos\Desktop\100 Days of Python Code\Day 38 - WorkOut Tracking using Google Sheets'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\nikos\Desktop\100 Days of Python Code\Day 38 - WorkOut Tracking using Google Sheets\Scripts\deactivate.nu'
