...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\nikos\Desktop\100 Days of Python Code\Day 28 - Pomodoro GUI Application'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\nikos\Desktop\100 Days of Python Code\Day 28 - Pomodoro GUI Application\Scripts\deactivate.nu'
